        ...
        <div class="contact ">
            ...
            <div class="side sdd2">
                <form class="frm">
                    ...
                    <input type="text" class="hal-inp fname" required style="float: right" placeholder="الاسم الشخصي"
                        name="fname" />
                    <input type="text" class="hal-inp lname" style="float: left " placeholder="الاسم العائلي"
                        name="lname" />
            ...
            $('.frm').on('submit', function(e) {
                ...
                ajax({
                    ...
                    if (response.status == 1) {
                        ...
                        $('.frm')[0].reset();
                        $('.suc-alr').html(
                            '<i class="bi bi-check-circle"></i> تلقينا رسالتك سوف نرد قريبا ');
