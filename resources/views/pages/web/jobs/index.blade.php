    ...
    <center>
        <div class="main">
            <form action="" method="get" >
                    <div class="search">
                        <input type="search" name="squery" class="squery" value="{{old('query')}}" placeholder="ابحث عن الوظيفة المناسبة "/><button type="submit" ><i class="bi bi-search"></i></button>
                    </div>
            </form>
            <div class="filter">
                ...
                <div class="contain">
                   ...
                   <div class="order order2">
                     @foreach ($categories as $category)
                      <div class="sel" id="{{$category->id}}" onclick="category(this)">{{$category->name}}</div>
                     @endforeach
                   </div>
                </div>
                <div class="contain">
        ...
        <div class="side">
           ...
           <div class="subscribe">
               ...
               <div class="su">
                   <h4 style='line-height:34px'>اشترك مجانا لتكون على اطلاع دائم على أهم الوظائف عبر رسائل البريد الالكتروني</h4>
                <form action="" method="" >
                 ...
                 $.ajaxSetup ({
                  ...
                  $.ajax({
                    ...
                    success:function(response){
                        ...
                        if(response.errors) {
                            $('.err-alr').html(`<i class="bi bi-exclamation-circle"></i> ${response.errors[0]}`) ;
                        ...
                        $('.suc-alr').html('<i class="bi bi-check-circle"></i>  تمت اضافة بريدك الالكتروني بنجاح ') ;
            ...
            $('.more').click(function(){
                ...
                $('.more').prop("disabled",true);
                 $.ajaxSetup ({
                  ...
                  $.ajax({
                    method: 'get' ,
                    url: "{{ route('web.jobs.load') }}?page="+page+"&category="+$('.ff2').attr("id")+"&city="+$('.ff3').attr("id")+"&type="+$('.ff1').attr("id") ,
            ...
            function type(cl){
                ...
                $.ajaxSetup ({
                  ...
                  $.ajax({
                    ...
                    data:{type:type,category:category,city:city},
                    success:function(response){
